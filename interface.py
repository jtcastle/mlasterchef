...
def load_models_only(seed_val):
    ...
    tokenizer = GPT2Tokenizer.from_pretrained("/home/phoebepi/mlasterchef/recipe_generator/gpt2_models/tokenizer")
    ...
    model = GPT2LMHeadModel.from_pretrained("/home/phoebepi/mlasterchef/recipe_generator/gpt2_models/model")
