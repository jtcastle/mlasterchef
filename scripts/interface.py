...
def generate_sample_from_user(model, ing_list, tokenizer, device):
    
    ing_list_str = '<|ingseparator|>'.join(ing_list)
    input_str = '<|startofing|>' + ing_list_str + '<|endofing|> <|startofsentence|>'
...
if __name__ == '__main__':
    ...
    generate_sample_from_user(model, ing_list, tokenizer, device)
